...
if __name__ == "__main__":
    ...
    for fp in pc_fps:
        ...
        if os.path.exists(out_mesh_fp):
            ...
            planes, paras = facade_remove(ransac_cc(pc_raw, sp=500, mnd=20, eps=0.15), th=15)
            ...
            if len(planes) == 0:
                ...
                # planes, paras = facade_remove(ransac_sac(pc_raw, sp=500, eps=0.15), th=15)
            ...
            if len(planes) == 0:
                ...
                # Domain direction computation
                _, theta, IOU = get_domain_direction(planes, simple_th=APD, alpha=0.5)
                thetas = get_thetas(theta, lod)
                # Plane resampling
